...
jest.mock('../crypto', () => ({
    ...
    getTag: jest.fn((tags, key) => {
        const tag = tags.find(t => t.length >= 2 && t[0] === key);
        return tag?.[1];
    }),
    truncateEventId: jest.fn((id) => id.slice(0, 16)),
...
const createMockResponse = () => {
    ...
    mockRes.send.mockImplementation((data) => {
        mockRes._data = data;
        return mockRes;
    });
...
describe('createAppState', () => {
    it('should create app state with config', () => {
        ...
        const state = (0, handlers_1.createAppState)(config);
...
describe('handleMetrics', () => {
    it('should return prometheus metrics', () => {
        ...
        const req = createMockRequest();
        const res = createMockResponse();
        (0, handlers_1.handleMetrics)(req, res, state);
...
describe('handleCreate', () => {
    ...
    it('should return contract on successful webhook', async () => {
        ...
        const res = createMockResponse();
        // Start the request
        const createPromise = (0, handlers_1.handleCreate)(req, res, state);
...
describe('handleCheck', () => {
    ...
    it('should return contract on successful webhook', async () => {
        ...
        const res = createMockResponse();
        const checkPromise = (0, handlers_1.handleCheck)(req, res, state);
        await new Promise(resolve => setTimeout(resolve, 50));
